= Contributing to GBIF documents
...
https://www.gbif.org[GBIF] invites community members to contribute to, improve and maintain our https://docs.gbif.org/documentation-guidelines/en/[digital documentation].
